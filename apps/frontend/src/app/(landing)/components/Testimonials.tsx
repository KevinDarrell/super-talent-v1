...
const testimonials = [
    {
        name: 'Vindo Raidansyah B',
        role: 'Project Manager',
        company: 'datAIsolv',
        image: '/testimonials/Vindo.jpeg',
        content: 'The CV analysis and scoring system are incredible. The `recommended actions` feature told me exactly what to fix to stand out. It’s a powerful tool that easily competes with the best global platforms out there.',
        rating: 5,
        highlight: 'Precision Analysis',
    },
    {
        name: 'Khansa Arshy',
        role: 'Marketing',
        company: 'Solusi Data Industri',
        image: '/testimonials/Khansya.jpeg',
        content: 'I love how I can just copy paste a URL or drag and drop my file. The process is so smooth and familiar. It’s rare to find a tool that balances such high level utility with a completely friction-less experience.',
        rating: 5,
    ...
    },
    {
        ...
        role: 'Marketing',
        company: 'AIFIYA',
        image: '/testimonials/Farrell.jpeg',
        content: 'The design is top tier minimalist, modern, and aesthetically superior. The color palette and subtle animations make the workspace feel premium. It’s clear that a lot of thought went into the visual consistency and user flow.',
        rating: 5,
        highlight: 'World-Class UI',
    },
];
