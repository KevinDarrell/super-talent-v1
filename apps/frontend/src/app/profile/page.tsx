...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors pb-8 overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pt-20 sm:pt-24">
                ...
                <Link
                    href="/"
                    className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 mb-4 sm:mb-6 transition-colors text-sm sm:text-base"
                >
                    <ArrowLeft size={18} />
                    Back to Dashboard
                </Link>
