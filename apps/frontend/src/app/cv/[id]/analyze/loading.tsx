...
/**
 * Premium loading UI for Analyze route transition
 * Features: Scanning animation, neural network effect, indigo theme
 */
        ...
        <div className="fixed inset-0 bg-slate-950 z-[100] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-indigo-500/20 rounded-full blur-[120px]"
                />
                <motion.div
                    animate={{
                        scale: [1.2, 1, 1.2],
                    ...
                    className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] bg-purple-500/15 rounded-full blur-[100px]"
                />
                ...
                >
                    {[
                        ...
                        <motion.div
                            ...
                            className="flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10"
                        >
